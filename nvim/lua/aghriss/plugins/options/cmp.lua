...
local tail_formatter = require("tailwindcss-colorizer-cmp").formatter
local formatting_style = {
  ...
  format = function(entry, item)
    ...
    return tail_formatter(entry, item)
    -- return item
  end,
}
...
local options = {
  ...
  window = {
    completion = {
      side_padding = (cmp_style ~= "atom" and cmp_style ~= "atom_colored") and 1
        or 0,
