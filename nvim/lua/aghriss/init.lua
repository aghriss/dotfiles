-- DEBUG = true
DEBUG = false
P = function(item) print(vim.inspect(item)) end
...
R = function(module) require("plenary.reload").reload_module(module) end
...
vim.api.nvim_create_user_command(
	"DuplicateMappings",
	function() require("aghriss.utils").check_mappings() end,
	{
